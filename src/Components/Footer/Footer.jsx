    ...
    <footer>
      ...
      <div className="social-links">
        <ul>
          ...
          <li>
            <a href="https://github.com/Himanshu-370" target="_blank">
              <svg
                width="40"
                height="40"
                fill="#000000"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/himanshu-singh-85454b160/"
              target="_blank"
            >
              <svg
                width="40"
          ...
          <li>
            <a
              href="https://www.instagram.com/himanshu.singh_20/"
              target="_blank"
            >
              <svg
                width="40"
