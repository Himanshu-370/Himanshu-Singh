  ...
  return (
    <div className="carousel">
      <Card
        date="January 2022"
        name="Mail Mapper"
        btn="The Ultimate Email Search Engine for Students and Professionals!"
        para1="● Developed a tool that allows users to search for the email addresses of employees at various companies."
        para2="● Built using React+Vite.js, Auth0 as the authentication, and Bootstrap as css library."
        link="https://github.com/Himanshu-370/Mail-Mapper"
      />
      <Card
        date="December 2022"
        name="RockaBuy"
